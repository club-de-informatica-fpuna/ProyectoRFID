...
from entidad.Prestamo import Prestamo
import os

class FormPrestamo:

    def __init__(self, view, title, update=False, prestamoUpdate=None, editable=True, raceById=None):
        self.view         = view
        self.title        = title
        self.update       = update
        self.prestamoUpdate = prestamoUpdate
    ...
    def createGridLayout(self):
        ...
        labelEquipo = QLabel("Equipo")
        labelResponsable = QLabel("Responsable")
        labelCedula = QLabel("Cedula de identidad")
        labelTelefono = QLabel("Celular")   
        labelCarreras = QLabel("Carrera")     
        labelFechaPrestamo = QLabel("Fecha Prestamo")
        labelFechaDevolucion = QLabel("Fecha Devolucion")
        labelFechaEstado = QLabel("Estado")
        ...
        self.layout.addWidget(labelEquipo,6,0,1,2)
        self.layout.addWidget(self.inputEquipo,7,0,1,2)
        ...
        self.layout.addWidget(labelFechaPrestamo,4,0,1,2)
        self.layout.addWidget(self.inputFechaPrestamo,5,0,1,2)
        self.layout.addWidget(labelFechaDevolucion,4,0,1,2)
        self.layout.addWidget(self.inputFechaDevolucion,5,0,1,2)
        self.layout.addLayout(horizontalLayout,12,0,1,2)
        self.layout.addWidget(labelEstado,6,0,1,2)        
        self.layout.addWidget(self.inputEstado,7,0,1,2)   
        ...
        # labelTelefono = QLabel("Celular")   
        # labelCarreras = QLabel("Carrera")     
        # labelFechaPrestamo = QLabel("F. Prestamo")
        # labelFechaDevolucion = QLabel("F. Devolucion")
        # labelFechaEstado = QLabel("Estado")
    ...
    def createGridUpdateLayout(self):
        ...
        labelDescripcion = QLabel("Equipo")
        labelNombre = QLabel("Nombre")
        labelApellido = QLabel("Apellido")
        labelCedula = QLabel("Cedula de identidad")
        labelTelefono = QLabel("Teléfono")
        labelCarreras = QLabel("Carrera")
        labelFechaPrestamo = QLabel("Fecha Préstamo")
        labelFechaDevolucion = QLabel("Fecha Devolución") 
        ...
        self.inputTelefono = QLineEdit(self.window)
        self.inputTelefono.setObjectName("inputFormEnable")
        self.inputTelefono.setText(self.prestamoUpdate.telefono)
        ...
        self.inputEmail = QLineEdit(self.window)
        self.inputEmail.setObjectName("inputFormEnable")
        self.inputEmail.setText(self.prestamoUpdate.email)
        ...
        self.inputCedula.setText(self.prestamoUpdate.ci)

        self.inputApellido = QLineEdit(self.window)
        self.inputApellido.setObjectName("inputFormEnable")
        self.inputApellido.setText(self.prestamoUpdate.apellido)
        ...
        self.inputNombre = QLineEdit(self.window)
        self.inputNombre.setObjectName("inputFormEnable")
        self.inputNombre.setText(self.prestamoUpdate.nombre)
        self.inputNombre.setFocus()
